...
export const scheduleLectureAPI = async (scheduleData = null) => {
  const endPoint = "http://localhost:5000/api/onlineLecture/scheduleLecture";
...
export const getAllScheduledLecturesAPI = async () => {
  const endPoint =
    "http://localhost:5000/api/onlineLecture/getAllScheduledLectures";
...
export const cancelScheduledLectureAPI = async (scheduleToRemove) => {
  const endPoint =
    "http://localhost:5000/api/onlineLecture/cancelScheduledLecture";
...
export const getStudentsLecturesAPI = async (requestBody = null) => {
  const endPoint =
    "http://localhost:5000/api/onlineLecture/getStudentsLectures";
